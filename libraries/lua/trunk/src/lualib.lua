...
package.language						= "c"
package.kind							= "lib"
package.config["DllDebug"].kind			= "dll"
package.config["DllRelease"].kind		= "dll"
...
package.config["DllDebug"].buildflags	= { "no-import-lib", "static-runtime" }
package.config["Release"].buildflags	= { "static-runtime", "no-symbols", "optimize-size" }
package.config["DllRelease"].buildflags = { "no-import-lib", "no-symbols", "optimize-size" }
